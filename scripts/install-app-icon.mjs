...
if(!fs.statSync(target).size)throw new Error('KleenestOS app icon decode produced an empty file.');
console.log(`Installed KleenestOS app icon at ${path.relative(root,target)}.`);
