...
for(const token of ['OWNER CONTROL CENTER','Kleenest Owner','showPassword','secureTextEntry={!showPassword}','Show password','Hide password'])if(!auth.includes(token))throw new Error(`Owner sign-in visibility contract missing ${token}`);
