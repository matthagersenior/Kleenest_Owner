...
export default function KleenestOSCommandCenter() {
  ...
  return <ScrollView contentInsetAdjustmentBehavior="automatic" refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refresh} />} contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 64 }}>
    ...
    <View style={{ gap: 9 }}>
      <SectionHeader title="Needs attention" body="KleenestOS promotes actionable platform conditions here instead of making you hunt through diagnostics." />
    ...
    <View style={{ gap: 9 }}>
      <SectionHeader title="Understand & govern" body="Intelligence, reporting, audits, capability state and advanced data work stay directly reachable without cluttering daily operations." />
      <DomainList routes={platformRoutes} subdued />
    </View>

    <View style={{ gap: 9 }}>
      <SectionHeader title="Recent control-plane activity" body="Audited platform changes and administrative history stay available below the live action surface." />
