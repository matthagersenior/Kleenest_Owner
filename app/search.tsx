...
const targets:SearchTarget[]=[
  ...
  {href:'/sponsored-ads',title:'Sponsored Advertising',description:'Approve and govern Kleenest Sponsored campaigns, placements, targeting, serving and performance.',keywords:['sponsored','advertising','ads','campaign','campaigns','placement','placements','targeting','admob','monetization'],section:'Owner controls'},
